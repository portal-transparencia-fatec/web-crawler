...
(async () => {
    ...
    const con = mysql.createConnection({
      ...
      user: "root",
      password: "",
      database: "portal-transparencia"
    });

    con.connect(function(err) {
      if (err) throw err;
      console.log("Connected!");
      var sql = `CREATE TABLE IF NOT EXISTS servidores (
    ...
    for (const [index, servidor] of servidores.entries()) {
       ...
       var sql = `INSERT INTO servidores (rgf, nome, cargo, referencia, regime, bruto, liquido, desconto) VALUES (
